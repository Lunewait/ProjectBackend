...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-07-2024 a las 04:35:29
...
(1, 'CHRIS BRANNY VILCA PUMA', '9356452789', 'AV. INDEPENDENCIA 234'),
(2, 'EMILIANO LEONARDO LAZO JUAREZ', '9356452789', 'AV. DOLORES 245');
...
(2, '2000', 'Papas', 8.00, 11.00, 20),
(3, '2001', 'shampoo', 9.00, 10.00, 6),
(4, '2002', 'limon', 10.00, 14.00, 5),
(5, '2003', 'Papel', 3.00, 8.00, 4),
(6, '2004', 'fideos', 5.00, 7.00, 2);
...
(1, 'Emiliano Leonardo', '34556566', 'calle san Juan de Dios 231', '931517379', 'lzxo@gmail.com'),
(2, 'Juan Luis Lopez', '345565634', 'Calle Arequipa 234', '934456782', 'Jllupez@gmail.com'),
(3, 'Luna Angel Sureste  Laxo', '345565636', 'Calle Alfonso Ugarte 345', '984562234', 'lunaanggeSer@gmail.com');
...
--
ALTER TABLE `proveedores`
  MODIFY `idproveedor` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
